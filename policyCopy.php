...
<main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Policy Copy</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Policy Copy</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      ...
      <div class="row mt-4" style="color:white; text-align:center;">
        ...
        <div class="col-lg-12">
            <b>
          "This feature is under development. We will be serving you soon..."
</b>
        </div>
      </div>
